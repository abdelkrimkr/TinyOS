...
void kmain(uint64_t multiboot_info_addr) {
    ...
    // UX: Help the user exit QEMU
    serial_print("\n" COLOR_YELLOW "To exit QEMU: Press Ctrl+A, then X" COLOR_RESET "\n");
